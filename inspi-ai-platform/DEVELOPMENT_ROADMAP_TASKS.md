...
#### 任务1.2: 卡片编辑功能 (4-5天)
- [ ] **卡片编辑器开发**
  - [ ] 富文本编辑器集成 (`src/components/cards/CardEditor.tsx`)
  - [ ] 卡片内容实时预览
  - [ ] 卡片样式自定义 (字体、颜色、布局)
  - [ ] 图片上传和插入功能
...
#### 任务1.3: 卡片导出和分享功能 (3-4天)
- [ ] **图片导出功能**
  - [ ] HTML转图片服务 (`src/lib/export/html-to-image.ts`)
  - [ ] 多种图片格式支持 (PNG, JPG, SVG)
  - [ ] 高清图片导出 (支持2x, 3x分辨率)
  - [ ] 批量导出功能

- [ ] **分享功能开发**
  - [ ] 社交媒体分享 (`src/components/cards/SharePanel.tsx`)
  - [ ] 分享链接生成
  - [ ] 二维码生成和分享
  - [ ] 分享统计和追踪
