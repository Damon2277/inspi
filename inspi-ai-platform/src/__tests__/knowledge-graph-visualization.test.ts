...
import { layoutManager } from '@/lib/graph-visualization/layout-algorithms'
...
describe('知识图谱可视化', () => {
  ...
  describe('工具函数', () => {
    it('应该能够计算两点间距离', () => {
      const { distance } = require('@/lib/graph-visualization/d3-utils')
    ...
    it('应该能够将点限制在矩形内', () => {
      const { constrainToRect } = require('@/lib/graph-visualization/d3-utils')
    ...
    it('应该能够将点对齐到网格', () => {
      const { snapToGrid } = require('@/lib/graph-visualization/d3-utils')
    ...
    it('应该能够生成节点工具提示', () => {
      const { generateNodeTooltip } = require('@/lib/graph-visualization/d3-utils')
    ...
    it('应该能够生成边工具提示', () => {
      const { generateEdgeTooltip } = require('@/lib/graph-visualization/d3-utils')
