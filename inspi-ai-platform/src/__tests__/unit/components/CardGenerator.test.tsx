...
import { CardGenerator } from '@/features/magic/CardGenerator';
...
jest.mock('@/core/ai/geminiService', () => mockAIService);
...
describe('CardGenerator组件测试', () => {
  ...
  describe('基础渲染', () => {
    ...
    test('应该在未登录时显示登录提示', () => {
      jest.mocked(require('@/shared/hooks/useAuth').useAuth).mockReturnValue({
        user: null,
