...
const PLACEHOLDER_MODE = process.env.HEALTHCHECK_PLACEHOLDER_MODE !== 'false';
  ...
  try {
    if (PLACEHOLDER_MODE) {
      return {
        ...
        message: '数据库检查处于占位模式',
        details: {
          note: '设置 HEALTHCHECK_PLACEHOLDER_MODE=false 并实现真实检查',
        },
      };
    }
