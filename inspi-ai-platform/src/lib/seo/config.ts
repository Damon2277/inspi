...
export const PAGE_SEO_CONFIG = {
  HOME: {
    ...
    keywords: ['AI教学魔法师', '教学创意生成', '智慧广场', '知识图谱', '教学工具'],
    path: '/',
  },
  ...
  SQUARE: {
    ...
    description: '浏览和复用全球教学创作者的优秀教学创意，按学科、学段筛选，发现最受欢迎的教学魔法。',
    keywords: ['智慧广场', '教学资源', '教学创意分享', '教学社区'],
    path: '/square',
  },

  LEADERBOARD: {
    title: '智慧贡献榜 - 教学荣誉与排名 | Inspi.AI',
    description: '查看贡献度排行榜，发现最受欢迎的教学作品，见证教学智慧的力量。',
    keywords: ['贡献度排行榜', '教学荣誉', '热门作品', '教学影响力'],
    path: '/leaderboard',
  },
  ...
  PROFILE: {
    ...
    keywords: ['个人知识图谱', '作品管理', '贡献度统计', '教学档案'],
    path: '/profile',
  },
} as const;
...
export const CONTENT_CONFIG = {
  ...
  // 排行榜内容
  LEADERBOARD_CONTENT: {
    title: '智慧贡献榜 - 见证教学智慧的力量',
    description: '这里记录着每一位教学创作者的贡献，每一次创作的价值，每一个作品的影响力。',
    sections: {
      contribution: '贡献度排行榜',
      trending: '热门作品推荐',
      weekly: '本周最受欢迎',
