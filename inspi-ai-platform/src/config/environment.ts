...
export const env = {
  ...
  DATABASE: {
    ...
    SERVER_SELECTION_TIMEOUT: parseInt(process.env.DB_SERVER_SELECTION_TIMEOUT || '5000'),
  ...
  AI: {
    ...
    SERVICE_TIMEOUT: parseInt(process.env.AI_SERVICE_TIMEOUT || '30000'),
    MAX_RETRIES: 3,
    RETRY_DELAY: 1000,
  ...
  // 限流配置
  RATE_LIMIT: {
    WINDOW: parseInt(process.env.RATE_LIMIT_WINDOW || '900000'), // 15分钟
